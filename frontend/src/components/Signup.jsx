...
function Signup() {
  ...
  const submitSignup = (e)=>{
    ...
    const res = signupApi(signupState);
    if(res)
      navigate("/home");
  }
          ...
          <form className='my-2 w-full px-20' onSubmit={submitSignup}>
              <div className="">
                  <div className="mb-6">
                      ...
                      <input onChange={onChangeHandler} type="text" name='name' id="first_name" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " placeholder="John"/>
                  </div>
                  <div className="mb-6">
